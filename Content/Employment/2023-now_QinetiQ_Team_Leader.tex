...
% \end{tightemize}
% 
I line manage a matrix team of 9 engineers (Apprentice to Principal level), contributing to strategic engineering initiatives and organizational development. The majority of my time is spent hands-on contributing to customer projects.
\vspace{0.25em}
\begin{tightemize}
    ...
    \item Built high-performing team using scrum-ban to improve deliver timeline while maintaining work-life balance
\end{tightemize}
\sectionsep{}
\vfill{}