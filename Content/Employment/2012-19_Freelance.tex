...
% \vspace{0.25em}
Designed audio and IP network systems for live events across the UK, modelling coverage in CAD and consolidating separate cable runs onto one fault-tolerant network.
\sectionsep{}